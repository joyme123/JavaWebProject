                                    ...
                                    <form class="form-horizontal" action="addOrderRecordAction" method="post">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <input id="userNamebyID" disabled="disabled" type="text" placeholder="" class="input-xlarge" name="orderRecord.userName" value="null">
                                            </div>
                                            <div class="control-group">
                                                <!-- Text input-->
                                                <label class="control-label" for="input01">商品编号</label>
                                                <input type="text" placeholder="" class="input-xlarge" name="orderRecord.carID">
                                            </div>
                                            <div class="control-group">
                                                <!-- Text input-->
                                                <label class="control-label" for="input01">商品名</label>
                                                <input disabled="disabled" type="text" placeholder="" class="input-xlarge" name="orderRecord.carName" value="null">
                                            </div>
                                            <div class="control-group">
                                                <!-- Text input-->
                                                <label class="control-label" for="input01">价格</label>
                                                <input type="text" placeholder="" class="input-xlarge" name="orderRecord.price">
                                            </div>
                                            <div class="control-group">
                                                <!-- Text input-->
                                                <label class="control-label" for="input01">折扣</label>
                                                <input type="text" placeholder="" class="input-xlarge" name="orderRecord.discount">
                                            </div>
                                            <div class="control-group">
                                                <!-- Text input-->
                                                <label class="control-label" for="input01">订单时间</label>
                                                <input type="date" placeholder="" class="input-xlarge" style="height: 26px;" name="orderRecord.time">
                                            </div>
                                            <div class="control-group" style="height: 75px;">
                                                <!-- Text input-->
                                                <label class="control-label" for="input01">备注</label>
                                                <textarea class="input-xlarge" rows="3" cols="30" style="float: right; resize: none;" name="orderRecord.note"></textarea>
                                            </div>
                                            <div class="controls">
                                        ...
                                        <td class="nopadding" colspan="10">
                                            <div id="detail<s:property value=" #orders.getIndex() "/>" class="detail">
                                                <form action="editOrderRecordAction" method="post">
                                                    <fieldset>
                                                        <input type="hidden" value="<s:property value=" #orderRecordList.id " />" name="orderRecord.id">
                                                        <div class="clearfix">
                                                        ...
                                                        <div class="clearfix">
                                                            <div class="detailitem">
                                                                <label class="control-label" for="input01">车型ID</label>
                                                                <input type="text" placeholder="" class="input-xlarge" style="margin-left: 1em;" value="<s:property value=" #orderRecordList.carID " />" name="orderRecord.carID">
                                                            </div>
                                                            <div class="detailitem">
                                                        ...
                                                        <div class="clearfix">
                                                            <div class="detailitem">
                                                                <label class="control-label" for="input01">折扣</label>
                                                                <input type="text" placeholder="" class="input-xlarge" style="margin-left: 2em;" value="<s:property value=" #orderRecordList.discount " />" name="orderRecord.discount">
                                                            </div>
                                                            <div class="detailitem">
                                                                <label class="control-label" for="input01">金额</label>
                                                                <input type="text" placeholder="" class="input-xlarge" style="margin-left: 2em;" value="<s:property value=" #orderRecordList.price " />" name="orderRecord.price">
                                                            </div>
                                                        </div>
                                                        <div class="clearfix">
                                                            <div class="detailitem">
                                                                <label class="control-label" for="input01">备注</label>
                                                                <textarea class="input-xlarge" rows="3" cols="30" type="text" class="input-xlarge" style="resize: none; margin-left: 2em;" name="orderRecord.note"><s:property value=" #orderRecordList.note " /></textarea>
                                                            </div>
                                                            <div class="detailitem">
                                                                <label class="control-label" for="input01">时间</label>
                                                                <input id="date" type="date" placeholder="" class="input-xlarge" style="margin-left: 2em;" value="<s:property value=" #orderRecordList.time " />" name="orderRecord.time">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="submit<s:property value=" #orders.getIndex() "/>" class="btn btn-success right detailbtn" onclick="dataSubmit(<s:property value=" #orders.getIndex() " />)">提交</div>
                                                    </fieldset>
                                                </form>
                                            </div>
                                        </td>
